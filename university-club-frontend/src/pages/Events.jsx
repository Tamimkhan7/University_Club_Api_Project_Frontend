      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        {events.length === 0 ? (
          <EmptyState
            ...
            message={searchTerm ? "Try a different search term" : "Create your first event to get started!"}
        ...
        <Pagination page={page} totalPages={totalPages} onPageChange={(p) => loadEvents(p, searchTerm)} />
      </div>
    </div>
  );
}